...
export class BlogService {
  ...
  constructor() {
    this.arrPost = [
      ...
      new Post('Mochila f-stop para fotógrafos. modelo Ajna', 'Atención fotógrafos: Esta mochila no es para ir vestidos de guapos y pasear por la ciudad con un cuerpo y un objetivo. Esta mochila, si se le quiere sacar partido, es para llevar material, almacenar y patear.', 'Pilar Jerico', '../assets/images/blog/foto2.jpg', 'viaje', 1),
